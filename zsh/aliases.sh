...
alias plum='java -jar /opt/homebrew/Cellar/plantuml/1.2025.9/libexec/plantuml.jar'
alias so='source ~/.venv/bin/activate'
alias sonb='source /Users/matthiasarchut/Library/Caches/pypoetry/virtualenvs/nautobot-db-systel-YOeu7QZw-py3.11/bin/activate'
# Git Pages check
